...
def thread_getOneBook(indexUrl):
    ...
    charts_url = []
    # 提取出书的每章节不变的url
    indexUrl = re.sub(r'/[0-9]*_[0-9]*/', '', indexUrl)
    charts = soup.select("#list dl dd a")
    for i in charts:
        # print(i.attrs['href'])
...
def process_getAllBook(base):
    ...
    book_indexUrl=[
        'https://www.xsbiquge.com/15_15338/',
        'https://www.xsbiquge.com/15_15339/',
        'https://www.xsbiquge.com/15_15340/'
    ]
    print("-------------------开始下载-------------------")
    p = []
