...
class download(object):
		...
		for child in download_soup.dl.children:
			if child != '\n':
				...
				if begin_flag == True and child.a != None:
					download_url = "https://www.xsbiquge.com/" + child.a.get('href')
	...
	def Downloader(self, url):
		...
		# texts = soup_texts.find_all(id = 'content', class_ = 'content_read')
		texts = soup_texts.find_all('div',id = 'content')
		# texts = soup_texts.find_all('div',class_ = 'box_con')
